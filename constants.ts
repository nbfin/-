...
export const THRESHOLD_TAX_RESIDENT_9A_9B = 20010; // Updated to 20010 based on PDF
...
export const INCOME_TYPE_LABELS: Record<IncomeType, string> = {
  ...
  [IncomeType.TYPE_51]: '租賃所得 (51)',
  [IncomeType.TYPE_50]: '兼職所得 (50)',
  [IncomeType.TYPE_91]: '競賽及中獎 (91)',
...
export const INCOME_TYPE_DESCRIPTIONS: Record<IncomeType, string> = {
  ...
  [IncomeType.TYPE_51]: '租賃房屋、土地、車位、借用場地所付的使用費、清理費等。',
  [IncomeType.TYPE_50]: '兼職人員薪資收入，也就是大部分的「打工仔」。',
  [IncomeType.TYPE_91]: '各項比賽獎金（實物依購買成本認列），年終尾牙摸彩之獎金或獎品。',
